...
A high-performance and lightweight Nginx base image for Docker based on Linux Alpine. It will serve anything in the `/var/www` directory.
...
Docker Hub
----------
The trusted build information can be found on the Docker Hub at https://registry.hub.docker.com/u/controlchannels/alpine-nginx/.
